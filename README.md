...
![Project Screenshot](https://50projects50days.com/img/projects-img/24-content-placeholder.png)

</div>

# README.md

It’s a bootstrap type card which shows the content placeholder (Loading Effect) before loading the actual content. This is built with Vanilla JS and CSS. In this I have used setTimout function to load data after X Delay.

Project Demo: [https://content-placeholder-by-shahid.netlify.app/](https://content-placeholder-by-shahid.netlify.app/)
